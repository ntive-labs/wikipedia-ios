...
public class CommonStrings: NSObject {
    ...
    @objc public static let fromWikipedia = WMFLocalizedString("explore-featured-article-sub-heading-from-language-wikipedia", value: "From %1$@ Wikipedia", comment: "Subtext beneath the 'Featured article' header when describing which specific Wikipedia. %1$@ will be replaced with the language - for example, 'From English Wikipedia'")

    @objc public static let defaultFromWikipedia = WMFLocalizedString("explore-featured-article-sub-heading-from-wikipedia", value: "From Wikipedia", comment: "Subtext beneath the 'Featured article' header when the specific language wikipedia is unknown.")
    ...
    @objc public static let usernameFieldTitle = WMFLocalizedString("vanish-account-username-field", value: "Username and user page", comment: "Title for the username and userpage form field")
    ...
    public static let activityTabAddImagesTitle = WMFLocalizedString("activity-tab-add-images-title", value: "Add images", comment: "Title for add images feature suggestion.")
    public static let activityTabAddImagesSubitle = WMFLocalizedString("activity-tab-add-images-subtitle", value: "Add suggested images to Wikipedia articles to enhance understanding.", comment: "Subtitle for add images feature.")
    ...
    public static let surveyVeryUnsatisfied = WMFLocalizedString("activity-tab-very-unsatisfied", value: "Very unsatisfied", comment: "Satisfaction survey very unsatisfied")
    public static let surveyUnsatisfied = WMFLocalizedString("activity-tab-unsatisfied", value: "Unsatisfied", comment: "Satisfaction survey unsatisfied")
    public static let surveyNeutral = WMFLocalizedString("activity-tab-neutral", value: "Neutral", comment: "Satisfaction survey neutral")
    public static let surveyAdditionalThoughts = WMFLocalizedString("activity-tab-additional-thoughts", value: "Any additional thoughts?", comment: "Asking user if they have any comments")
